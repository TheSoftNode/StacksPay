  ...
  return (
    <div className="relative flex-shrink-0">
      <motion.div
        ...
        className="relative mx-auto w-80 h-[640px]"
      >
        {/* Phone Outer Frame */}
        <div className="absolute inset-0 bg-gradient-to-b from-gray-800 to-gray-900 rounded-[3rem] p-2 shadow-2xl">
          ...
          <div className="relative w-full h-full bg-black rounded-[2.5rem] overflow-hidden">
            ...
            <div className="absolute inset-2 bg-white rounded-[2rem] overflow-hidden">
              {/* Dynamic Island */}
              <div className="absolute top-6 left-1/2 transform -translate-x-1/2 w-32 h-6 bg-black rounded-full z-20" />
              
              {/* Status Bar */}
              <div className="absolute top-4 left-6 right-6 flex items-center justify-between text-black z-10">
